...
class _$ProductImageTearOff {
  ...
  _ProductImage call({required String id, required String url}) {
...
class _$_ProductImage extends _ProductImage {
  const _$_ProductImage({required this.id, required this.url}) : super._();
...
abstract class _ProductImage extends ProductImage {
  const factory _ProductImage({required String id, required String url}) =
      _$_ProductImage;
